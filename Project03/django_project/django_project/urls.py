...
urlpatterns = [
    ...
    path('e/antemiaa/password-reset/',
    auth_views.PasswordResetView.LogoutView.as_view(template_name= 'users/password_reset.html'),
    name ='password_reset'),

    path('e/antemiaa/password-reset/done',
    auth_views.PasswordResetViewDone.LogoutView.as_view(template_name= 'users/password_reset_done.html'),
